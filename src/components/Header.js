          ...
          <Navbar.Collapse>
            <Nav>
              ...
              <NavDropdown eventKey={6} title="More..." id="more-dropdown" noCaret>
                <MenuItem className="moreMenu" eventKey={6.1} href="/About">About Us <span className="icon-cogs"></span></MenuItem>
                <MenuItem className="moreMenu" eventKey={6.2} href="/Photos">Photos <span className="icon-images2"></span></MenuItem>
                <MenuItem className="moreMenu" eventKey={6.3} href="/Employment">Employment <span className="icon-profile2"></span></MenuItem>
              </NavDropdown>
